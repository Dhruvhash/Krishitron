...
char auth[] = "vDUz2XCCKt7eBI7i3HB1AEeZxgD455dL";  //Enter your Blynk Auth token
char ssid[] = "alu";  //Enter your WIFI SSID
...
void PIRsensor() {
  ...
  if (value) {
    Blynk.logEvent("koi hila","WARNNG! Motion Detected!"); //Enter your Event Name
    WidgetLED LED(V5);
    LED.on();
  } else {
    WidgetLED LED(V5);
